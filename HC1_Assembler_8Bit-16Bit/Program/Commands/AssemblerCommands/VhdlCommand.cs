...
{
    [Command("-v")]
    public class VhdlCommand : ICommand
    {
        private readonly List<string> _args;

        public VhdlCommand(IEnumerable<string> args)
        {
        ...
        public void Execute()
        {
            ...
            {
                Assembler.Assembler.GenerateFilesetOutput(file, Assembler.Assembler.AssembleToVhdl(file), "vhd");
            }
        }
    }
}